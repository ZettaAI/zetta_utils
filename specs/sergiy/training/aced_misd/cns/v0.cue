...
#EXP_VERSION: "tmp_cns_zm2_thr\(#FIELD_MAGN_THR)_x3"

#MODEL_CKPT: null

#SRC_CV: "gs://sergiy_exp/aced/demo_x0/rigid_to_elastic/raw_img_masked"
#TGT_CV: "gs://sergiy_exp/aced/cns/giber_x0_enc/imgs_warped/-2"
...
#val_dset: #dset_settings & {
	...
	datasets: images: sample_indexer: bbox: {
		start_coord: [1024 * 55, 1024 * 25, 2504]
		end_coord: [1024 * 70, 1024 * 50, 2505]
		resolution: [4, 4, 45]
	}
}
