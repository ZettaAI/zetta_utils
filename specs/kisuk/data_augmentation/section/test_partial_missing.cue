...
#PAD_SIZE:		[16, 16, 16]
#MODEL_CKPT:  	null
#EXP_VERSION: 	"partial_missing_prob[1]_rate[0.0-0.5]_fill[0-1](per_section)(per_partial)_t0"
...
#train_dset: #dset_settings & {
	...
	layer: read_procs: [
        ...
        {
            "@type": "PartialMissingSection"
			prob: 1
            key: "data_in"
			// rate: 0.5
			rate: {"@type": "uniform_distr", low: 0, high: 0.5}
			// fill: 0.5
