...
if __name__ == "__main__":
    ...
    L1_WEIGHT_END_VAL = 0.12
    L1_WEIGHT_START_EPOCH = 1
    L1_WEIGHT_END_EPOCH = 13
    LOCALITY_WEIGHT = 1.0
    SIMILARITY_WEIGHT = 0.0
    CHUNK_SIZE = 1024
    FM = 32
    INPUT_DS_FACTOR = 2  # M3 -> M4
    DS_FACTOR = 32
    CHANNELS = 4
    EXP_NAME = "general_coarsener_loss"
    TRAINING_ROOT = "gs://zetta-research-nico/training_artifacts"

    EXP_VERSION = f"1.0.0_M4_M9_C{CHANNELS}_lr{LR}_locality{LOCALITY_WEIGHT}_similarity{SIMILARITY_WEIGHT}_l1{L1_WEIGHT_START_VAL}-{L1_WEIGHT_END_VAL}_N1x4"
    ...
    SOURCE_PATHS = {
        "microns_pinky": {
            "contiguous": True,
            "resolution": [32 * INPUT_DS_FACTOR, 32 * INPUT_DS_FACTOR, 40],
            "num_samples": 5019,
        },
        # "microns_basil": {
        #     "contiguous": True,
        ...
        "aibs_v1dd": {
            "contiguous": False,
            "resolution": [38.8 * INPUT_DS_FACTOR, 38.8 * INPUT_DS_FACTOR, 45],
            "num_samples": 5805,
        },
        "kim_n2da": {
            "contiguous": True,
            "resolution": [32 * INPUT_DS_FACTOR, 32 * INPUT_DS_FACTOR, 50],
            "num_samples": 446,
        },
        "kim_pfc2022": {
            "contiguous": True,
        ...
        "kronauer_cra9": {
            "contiguous": True,
            "resolution": [32 * INPUT_DS_FACTOR, 32 * INPUT_DS_FACTOR, 42],
            "num_samples": 740,
        },
        "kubota_001": {
            "contiguous": True,
            "resolution": [40 * INPUT_DS_FACTOR, 40 * INPUT_DS_FACTOR, 40],
            "num_samples": 4744,
        },
        "lee_fanc": {
            "contiguous": False,
            "resolution": [34.4 * INPUT_DS_FACTOR, 34.4 * INPUT_DS_FACTOR, 45],
            "num_samples": 1605,
        },
        "lee_banc": {
            "contiguous": False,
            "resolution": [32 * INPUT_DS_FACTOR, 32 * INPUT_DS_FACTOR, 45],
            "num_samples": 742,
        },
        "lee_ppc": {
            "contiguous": True,
        ...
        "lichtman_zebrafish": {
            "contiguous": False,
            "resolution": [32 * INPUT_DS_FACTOR, 32 * INPUT_DS_FACTOR, 30],
            "num_samples": 2799,
        },
        "prieto_godino_larva": {
            "contiguous": True,
            "resolution": [32 * INPUT_DS_FACTOR, 32 * INPUT_DS_FACTOR, 32],
            "num_samples": 4584,
        },
        "fafb_v15": {
            "contiguous": False,
        ...
        "lichtman_h01": {
            "contiguous": False,
            "resolution": [32 * INPUT_DS_FACTOR, 32 * INPUT_DS_FACTOR, 33],
            "num_samples": 6624,
        },
        "janelia_hemibrain": {
            "contiguous": True,
        ...
        "bumbarber_2013": {
            "contiguous": True,
            "resolution": [31.2 * INPUT_DS_FACTOR, 31.2 * INPUT_DS_FACTOR, 50],
            "num_samples": 7325,
        },
        "wilson_2019_p3": {
            "contiguous": True,
        ...
        "model": {
            ...
            "model": {
                ...
                "modules": [
                    ...
                    {"@type": "torch.nn.MaxPool2d", "kernel_size": 2},
                    {
                        "@type": "ConvBlock",
                        "num_channels": [FM, FM, FM],
                        "kernel_sizes": [3, 3],
                        "padding_modes": "reflect",
                        "activate_last": True,
                        "skips": {"0": 2},
        ...
        "sampler": {
            ...
            "sampler": {
                ...
                "data_source": {
                    "@type": "torch.arange",
                    "end": sum(
                        [cast(int, settings["num_samples"]) for settings in SOURCE_PATHS.values()]
                    ),
                },
                "replacement": False,
                "num_samples": 8000,
    ...
    lightning_train(
        ...
        image="us-east1-docker.pkg.dev/zetta-research/zutils/zetta_utils:nico_py3.9_20240103",
        resource_limits={"nvidia.com/gpu": "4"},
        resource_requests={"memory": "27560Mi", "cpu": 28},
        follow_logs=False,
