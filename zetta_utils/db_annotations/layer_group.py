...
class LayerGroupDBEntry:
    ...
    @staticmethod
    def from_dict(layer_group_id: str, raw_dict: dict) -> LayerGroupDBEntry:
...
@overload
def read_layer_groups() -> dict[str, LayerGroupDBEntry]:
    ...
...
@overload
def read_layer_groups(*, collection_ids: list[str] | None = ...) -> dict[str, LayerGroupDBEntry]:
    ...
...
def read_layer_groups(*, layer_group_ids=None, collection_ids=None):
    ...
    if collection_ids:
        ...
        result = {k: LayerGroupDBEntry.from_dict(k, cast(dict, v)) for k, v in result_raw.items()}
        ...
        result_raw = LAYER_GROUPS_DB[idx]
        result = [
            LayerGroupDBEntry.from_dict(layer_group_ids[i], result_raw[i])
