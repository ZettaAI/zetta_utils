...
#CHUNK_SIZE:  	[72, 72, 72]
#PAD_SIZE:		[12, 12, 12]
#MODEL_CKPT:  	"\(#TRAINING_ROOT)/\(#EXP_NAME)/local_gpu1_w_tracing_x1/last.ckpt"
#EXP_VERSION: 	"local_gpu1_w_tracing_x2"
...
worker_image: "us.gcr.io/zetta-research/zetta_utils:kisuk-playground-p310"
worker_resources: {
	memory:           "18560Mi"
	"nvidia.com/gpu": "1"
}
...
#val_dset: #dset_settings & {
	layer: layers: data_in: path: "gs://zetta_research_datasets/zettasets/hemibrain/eb-outer/image"
	layer: layers: target: path: "gs://zetta_research_datasets/zettasets/hemibrain/eb-outer/seg/000"
	layer: read_procs: [
		{
			"@type": "ROIMaskProcessor"
			start_coord: [128, 128, 128]
