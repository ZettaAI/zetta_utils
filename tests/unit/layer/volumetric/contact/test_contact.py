...
from zetta_utils.layer.volumetric.contact import Contact
...
def test_contact_instantiation():
    ...
    contact = make_contact(id=42, seg_a=100, seg_b=200, com=(50.0, 60.0, 70.0))
...
def test_contact_with_optional_fields():
...
def test_contact_defaults_to_none():
...
def test_in_bounds_com_inside():
    ...
    contact = make_contact(com=(100.0, 100.0, 100.0))
...
def test_in_bounds_com_outside():
    ...
    contact = make_contact(com=(300.0, 300.0, 300.0))
...
def test_in_bounds_com_on_boundary_end():
    ...
    contact = make_contact(com=(200.0, 200.0, 200.0))
...
def test_in_bounds_with_resolution():
    ...
    contact = make_contact(com=(1600.0, 1600.0, 4000.0))
...
def test_in_bounds_partial_outside():
    ...
    contact = make_contact(com=(100.0, 100.0, 300.0))
...
def test_with_converted_coordinates_returns_new_instance():
    """Test that with_converted_coordinates returns a new Contact."""
    contact = make_contact()
