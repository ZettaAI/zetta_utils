...
#LOWCONF_WEIGHT:  0.0
#ENC_CH:          1
#EXP_VERSION:     "128_256_chunk_z\(#IMG_CHUNK_Z)_sig\(#SIGNI_WEIGHT)_lr\(#LR)_fieldmag\(#FIELD_MAG)_neighbor\(#NEIGHBOR_WEIGHT)_conv3_cns_1chlowconf\(#LOWCONF_WEIGHT)_cross_encch\(#ENC_CH)_x6"
#CHUNK_XY:        1024
...
worker_image: "us.gcr.io/zetta-research/zetta_utils:sergiy_all_p39_x45"
worker_resources: {
	memory:           "18560Mi"
	"nvidia.com/gpu": "1"
}
