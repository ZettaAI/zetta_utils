...
// if false {
    ...
    #PAIR_FLOW_TMPL: run_enc_warped_imgs: #RUN_MISD
}
// if true {
if false {
    ...
    #PAIR_FLOW_TMPL: misd_flow_kwargs: dst_path: "misalignments-v2-z2-retry"
    #MISD_MODEL: {fn: {"@type": "MisalignmentDetector", model_path: #MISD_MODEL_PATH,
                       apply_sigmoid: true}}
    #PAIR_FLOW_TMPL: misd_flow_kwargs: models: [#MISD_MODEL]
    #PAIR_FLOW_TMPL: run_enc_warped_imgs: #RUN_MISD
...
// if true {
if false {
    // configs for misd-v2, z-2 model, once z-1 model has been run
    #MISD_MODEL_PATH: "gs://zetta-research-nico/training_artifacts/aced_misd_general/3.2.0_dsfactor2_thr2.0_lr0.0001_z2/epoch=74-step=18730-backup.ckpt.model.spec.json"
    #MISD_ENCODER: #GENERAL_ENC_MODELS_V2["64"]
    #PAIR_FLOW_TMPL: misd_flow_kwargs: src_path: "imgs_warped_encoded-v2-z1"
    #PAIR_FLOW_TMPL: misd_flow_kwargs: tgt_path: "encodings_misd-v2-z1"
    #PAIR_FLOW_TMPL: misd_flow_kwargs: dst_path: "misalignments-v2-z2"
    #MISD_MODEL: {fn: {"@type": "MisalignmentDetector", model_path: #MISD_MODEL_PATH,
                       apply_sigmoid: true}}
    #PAIR_FLOW_TMPL: misd_flow_kwargs: models: [#MISD_MODEL]
    #PAIR_FLOW_TMPL: run_enc_warped_imgs: false
}
// if true {
if false {
...
#GENERAL_ENC_MODELS_V2: {
    ...
    "64": {
        ...
        path: "gs://dkronauer-ant-001-binaries/general_encoders_2023_32_64_C1_2023-11-20.static-2.0.1-model.jit"
