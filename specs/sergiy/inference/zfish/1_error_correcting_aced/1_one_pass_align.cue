...
//OUTPUTS
#FOLDER:          "gs://sergiy_exp/aced/zfish/one_pass_debug_baseline_x5"
...
#WARP_FLOW_TMPL: {
	...
	chunk_size: [2048, 2048, 1]
	bcube: #BCUBE
	dst_resolution: [256, 256, 30] //[32, 32, 30]
	src: {
		"@type":         "build_cv_layer"
		path:            _
		read_postprocs?: _
...
max_task_retry: 1
worker_image:   "us.gcr.io/zetta-research/zetta_utils:sergiy_inference_x45"
worker_resources: {
	memory:           "18560Mi"
	"nvidia.com/gpu": "1"
}
