...
#TARGET_ENC_PATH:                   "gs://tmp_2w/nico/cra8/enc/z0_thick"
#TARGET_MASKED_ENC_PATH:            "gs://tmp_2w/nico/cra8/enc/z0_masked_thick"
...
#ALIGNED_FIELD_PATH:                "gs://tmp_2w/nico/cra8/field_fwd_align_thick_sm100" //_M6xSM\(_ALIGN_PARAMS["256"].sm)_M5xSM\(_ALIGN_PARAMS["128"].sm)_M4xSM\(_ALIGN_PARAMS["64"].sm)"
#ALIGNED_IMG_PATH:                  "gs://tmp_2w/nico/cra8/img_fwd_align_thick_sm100" //_M6xSM\(_ALIGN_PARAMS["256"].sm)_M5xSM\(_ALIGN_PARAMS["128"].sm)_M4xSM\(_ALIGN_PARAMS["64"].sm)"
#ALIGNED_ENC_PATH:                  "gs://tmp_2w/nico/cra8/enc_fwd_align_thick_sm100" //_M6xSM\(_ALIGN_PARAMS["256"].sm)_M5xSM\(_ALIGN_PARAMS["128"].sm)_M4xSM\(_ALIGN_PARAMS["64"].sm)"
...
_ALIGN_PARAMS: {
	...
	"128": {sm: 100, num_iter: 500, lr: 0.05},
	"64":  {sm: 100, num_iter: 300, lr: 0.1},
	"32":  {sm: 100, num_iter: 200, lr: 0.1},
}
...
target: {
	...
	stages: [
		...
		// 	]
		// },
		// #COMPOSE_Z1_Z1INV_FIELD_TEMPLATE & {
		// 	dst_resolution: #HIGH_RES
		// },
		{
			"@type": "mazepa.concurrent_flow"
		...
		},
		{
			"@type": "mazepa.concurrent_flow"
			stages: [
				for i in list.Range(1, 5, 1) for j in [2] {
...
#INVERT_FIELD_TEMPLATE: {
	...
	dst: {
		"@type":             "build_cv_layer"
		path:                #ALIGNED_FIELD_PATH + "/z\(_z_offset)_inv"
		info_reference_path: op_kwargs.src.path
	}
}
...
#COMPOSE_Z1_Z1INV_FIELD_TEMPLATE: {
	...
	op_kwargs: {
		src: {
			"@type": "build_cv_layer"
			path:    #ALIGNED_FIELD_PATH + "/z-1_inv"
		}
		field: {
			"@type": "build_cv_layer"
			path:    #ALIGNED_FIELD_PATH + "/z1"
		}
	}
	dst: {
		"@type":             "build_cv_layer"
		path:                #ALIGNED_FIELD_PATH + "/z2_composed"
		index_procs: [{
