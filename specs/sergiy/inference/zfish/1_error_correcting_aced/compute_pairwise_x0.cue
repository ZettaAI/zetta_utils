...
//OUTPUTS
#FOLDER:          "gs://sergiy_exp/aced/zfish/large_test_x8"
...
#AFIELD_PATH:             "\(#FOLDER)/afield"
#IMG_ALIGNED_PATH:        "\(#FOLDER)/img_aligned"
#IMG_MASK_PATH:           "\(#FOLDER)/img_mask"
#IMG_ALIGNED_MASKED_PATH: "\(#FOLDER)/img_aligned_masked"
			...
			stages: [
				{
					...
					stages: [
						#CF_FLOW_TMPL & {
							dst: path: "\(#FIELDS_BWD_PATH)/\(offest)"
							tmp_layer_dir: "\(#FIELDS_BWD_PATH)/\(offest)/tmp"
							src_offset: [0, 0, offset]
						},
						#CF_FLOW_TMPL & {
							dst: path: "\(#FIELDS_FWD_PATH)/\(offest)"
							tmp_layer_dir: "\(#FIELDS_FWD_PATH)/\(offest)/tmp"
							tgt_offset: [0, 0, offset]
						},
					]
				},
				#WARP_FLOW_TMPL & {
					src: path:   #IMG_PATH
					field: path: "\(#FIELDS_BWD_PATH)/\(offest)"
					dst: path:   "\(#IMGS_WARPED_PATH)/\(offset)"
				},
				#ENCODE_FLOW_TMPL & {
					src: path: "\(#IMGS_WARPED_PATH)/\(offset)"
					dst: path: "\(#WARPED_BASE_ENCS_PATH)/\(offset)"
				},
				#MISD_FLOW_TMPL & {
					tgt: path: "\(#WARPED_BASE_ENCS_PATH)/\(offset)"
					dst: path: "\(#MISALIGNMENTS_PATH)/\(offset)"
				},
...
max_task_retry: 2
worker_image:   "us.gcr.io/zetta-research/zetta_utils:sergiy_inference_x23"
worker_resources: {
	memory:           "18560Mi"
	"nvidia.com/gpu": "1"
}
