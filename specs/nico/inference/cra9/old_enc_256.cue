...
#TARGET_ENC_PATH:                   "gs://tmp_2w/nico/cra8/enc/z0_old_enc"
#TARGET_MASKED_ENC_PATH:            "gs://tmp_2w/nico/cra8/enc/z0_masked_new_enc"
...
#ALIGNED_FIELD_PATH:                "gs://tmp_2w/nico/cra8/field_fwd_align_old_enc256" //_M6xSM\(_ALIGN_PARAMS["256"].sm)_M5xSM\(_ALIGN_PARAMS["128"].sm)_M4xSM\(_ALIGN_PARAMS["64"].sm)"
#ALIGNED_IMG_PATH:                  "gs://tmp_2w/nico/cra8/img_fwd_align_old_enc256" //_M6xSM\(_ALIGN_PARAMS["256"].sm)_M5xSM\(_ALIGN_PARAMS["128"].sm)_M4xSM\(_ALIGN_PARAMS["64"].sm)"
#ALIGNED_ENC_PATH:                  "gs://tmp_2w/nico/cra8/enc_fwd_align_old_enc256_render_new" //_M6xSM\(_ALIGN_PARAMS["256"].sm)_M5xSM\(_ALIGN_PARAMS["128"].sm)_M4xSM\(_ALIGN_PARAMS["64"].sm)"
		...
		// },
		{
			...
			stages: [
				for i in [2] {
					#WARP_IMG_TEMPLATE & {
						_z_offset:      i
						dst_resolution: [256, 256, 42] // #HIGH_RES
					}
				},
			]
		},
