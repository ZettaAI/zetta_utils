#IMG_PATH: "gs://dacey-human-retina-001-alignment/img/v1"
#IMG_RES: [5, 5, 50]
...
if #TEST_SMALL == true {
    ...
    #RELAXATION_RESOLUTION: [640, 640, #IMG_RES[2]]
    #BLOCKS: [
        {_z_start: 1, _z_end: 101,   _fix:  "both"},
        {_z_start: 100, _z_end: 201,   _fix:  "both"},
        {_z_start: 200, _z_end: 301,   _fix:  "both"},
        {_z_start: 300, _z_end: 401,   _fix:  "both"},
        {_z_start: 400, _z_end: 501,   _fix:  "both"},
        {_z_start: 500, _z_end: 601,   _fix:  "both"},
        {_z_start: 600, _z_end: 702,   _fix:  "both"},
        {_z_start: 701, _z_end: 801,   _fix:  "both"},
        {_z_start: 800, _z_end: 901,   _fix:  "both"},
        {_z_start: 900, _z_end: 1001,   _fix:  "both"},
        {_z_start: 1000, _z_end: 1101,   _fix:  "both"},
        {_z_start: 1100, _z_end: 1201,   _fix:  "both"},
        {_z_start: 1200, _z_end: 1301,   _fix:  "both"},
        {_z_start: 1300, _z_end: 1401,   _fix:  "both"},
        {_z_start: 1400, _z_end: 1501,   _fix:  "both"},
        {_z_start: 1500, _z_end: 1601,   _fix:  "both"},
        {_z_start: 1600, _z_end: 1701,   _fix:  "both"},
        {_z_start: 1700, _z_end: 1803,   _fix:  "both"},
        {_z_start: 1802, _z_end: 1901,   _fix:  "both"},
        {_z_start: 1900, _z_end: 2001,   _fix:  "both"},
        {_z_start: 2000, _z_end: 2101,   _fix:  "both"},
        {_z_start: 2100, _z_end: 2201,   _fix:  "both"},
        {_z_start: 2200, _z_end: 2301,   _fix:  "both"},
        {_z_start: 2300, _z_end: 2401,   _fix:  "both"},
        {_z_start: 2400, _z_end: 2501,   _fix:  "both"},
        {_z_start: 2500, _z_end: 2601,   _fix:  "both"},
        {_z_start: 2600, _z_end: 2701,   _fix:  "both"},
        {_z_start: 2700, _z_end: 2801,   _fix:  "both"},
        {_z_start: 2800, _z_end: 2901,   _fix:  "both"},
        {_z_start: 2900, _z_end: 3030,   _fix:  "both"},
    ...
    // misalignments
    #MATCH_OFFSETS_FLOW: op_kwargs: misalignment_masks: "-1": data_resolution: [640, 640, #IMG_RES[2]]
    #MATCH_OFFSETS_FLOW: op_kwargs: misalignment_masks: "-2": data_resolution: [640, 640, #IMG_RES[2]]

    #MATCH_OFFSETS_FLOW: op_kwargs: tissue_mask: data_resolution: [640, 640, #IMG_RES[2]]
    // fields
    #MATCH_OFFSETS_FLOW: op_kwargs: pairwise_fields: "-1": data_resolution: [640, 640, #IMG_RES[2]]
    #MATCH_OFFSETS_FLOW: op_kwargs: pairwise_fields: "-2": data_resolution: [640, 640, #IMG_RES[2]]
    #MATCH_OFFSETS_FLOW: op_kwargs: pairwise_fields_inv: "-1": data_resolution: [640, 640, #IMG_RES[2]]
    #MATCH_OFFSETS_FLOW: op_kwargs: pairwise_fields_inv: "-2": data_resolution: [640, 640, #IMG_RES[2]]
    #RELAX_FLOW: op_kwargs: pfields: "-1": data_resolution: [640, 640, #IMG_RES[2]]
    #RELAX_FLOW: op_kwargs: pfields: "-2": data_resolution: [640, 640, #IMG_RES[2]]
    // defect mask
    #DEFECTS_PATH: "gs://dacey-human-retina-001-alignment-temp/rigid/defect_mask_refine"
    #RELAX_FLOW: op_kwargs: rigidity_masks: data_resolution: [640, 640, #IMG_RES[2]]
...
#RELAX_OUTCOME_CHUNK_SIZE: [384, 384, 1]

// OTHER VARIABLES
#DEBUG_SUFFIX: _ | *"_final_v1"
...
#TISSUE_MASK_PATH:          "gs://dacey-human-retina-001-alignment-temp/rigid/tissue_no_defect_mask"
...
#RELAX_FLOW: {
    ...
    op_kwargs: {
        ...
        let match_offsets_path = "\(#MATCH_OFFSET_BASE)_1_3030"
        match_offsets: {
            "@type": "build_cv_layer"
            path:    match_offsets_path
            //info_reference_path: #IMG_PATH
...
#RUN_INFERENCE: {
    ...
    // worker_image:           "us-east1-docker.pkg.dev/zetta-research/zutils/zetta_utils:nico_py3.9_20240208_2"
    // worker_resources: {
    //     "nvidia.com/gpu"?: _
    // }
