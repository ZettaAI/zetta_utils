...
import torch
from pytorch_lightning.plugins.environments import torchelastic_environment
...
trainer = pl.Trainer(
    accelerator="cuda",
    devices=int(os.environ.get("NUM_DEVICES", "1")),
    max_epochs=4,
    num_nodes=int(os.environ.get("NUM_NODES", "1")),
    strategy=ddp.DDPStrategy(
        find_unused_parameters=False,
        cluster_environment=torchelastic_environment.TorchElasticEnvironment(),
    ),
)
