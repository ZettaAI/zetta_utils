...
if __name__ == "__main__":
    ...
    CHUNK_SIZE = 1024
    FM = 32
    EXP_NAME = "general_encoder_loss"
    TRAINING_ROOT = "gs://zetta-research-nico/training_artifacts"

    EXP_VERSION = f"1.0.33_M3_M3_unet_fm{FM}-256_conv4_lr{LR}_locality{LOCALITY_WEIGHT}_similarity{SIMILARITY_WEIGHT}_l1{L1_WEIGHT_START_VAL}-{L1_WEIGHT_END_VAL}_N1x4"
