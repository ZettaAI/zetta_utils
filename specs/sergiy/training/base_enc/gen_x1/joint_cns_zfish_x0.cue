...
#EQUI_WEIGHT:   0.5
#CHUNK_XY:      1024
#EXP_VERSION:   "tmp_ft_patch\(#CHUNK_XY)_post\(#POST_WEIGHT)_lr\(#LR)_deep_k\(#K)_clip\(#CLIP)_equi\(#EQUI_WEIGHT)_f1f2_tileaug_x17_cns_joint_gamma_aug_baseline_x0"
...
worker_image: "us.gcr.io/zetta-research/zetta_utils:sergiy_train_p39_x5"
worker_resources: {
	memory:           "18560Mi"
	"nvidia.com/gpu": "1"
}
