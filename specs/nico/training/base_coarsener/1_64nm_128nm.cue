...
#K:             3
#EQUI_WEIGHT:   0.5
#EXP_VERSION:   "tmp_ft_patch\(#CHUNK_XY)_post\(#POST_WEIGHT)_postmult\(#POST_WEIGHT_MULT)_lr\(#LR)_deep_k\(#K)_clip\(#CLIP)_equi\(#EQUI_WEIGHT)_fmt\(#FIELD_MAGNITUDE_THRESHOLD)_f1f2_apply_1_m4_int8_more_data_5"
#CHUNK_XY:      1024
#FIELD_MAGNITUDE_THRESHOLD: 1.1

#START_EXP_VERSION: "tmp_ft_patch1024_post1.55_postmult1.05_lr0.0001_deep_k3_clip0.00000_equi0.5_fmt1.1_f1f2_apply_1_m4_int8_more_data_4"
		...
		images: {
            ...
            layer: {
                ...
                layers: {
                    src: {
                        "@type": "build_cv_layer"
                        path:    "gs://zetta_lee_fly_cns_001_alignment_temp/experiments/encoding_coarsener/gamma_low0.25_high4.0_prob1.0_tile_0.1_0.4_lr0.0001_post1.7_zfish_cns_64nm_unet"
                        cv_kwargs: {
