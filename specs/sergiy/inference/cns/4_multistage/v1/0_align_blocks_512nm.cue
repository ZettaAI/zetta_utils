...
#RELAXATION_SUFFIX: "_\(#RELAXATION_RESOLUTION[0])nm_try_x7_iter\(#RELAXATION_ITER)_rig\(#RELAXATION_RIG)_lr\(#RELAXATION_LR)"
#RELAXATION_RESOLUTION: [512, 512, 45]
...
#BLOCKS: [
	...
	{_z_start: 2701, _z_end: 3155},
	//{_z_start: 2919, _z_end: 2935},
]
...
#RUN_INFERENCE: {
	...
	worker_image: "us.gcr.io/zetta-research/zetta_utils:sergiy_all_p39_x156"
	worker_resources: {
		memory:           "18560Mi"
		"nvidia.com/gpu": "1"
	}
	//                      checkpoint:             "gs://zetta_utils_runs/sergiy/exec-accomplished-funny-lobster-from-uranus/2023-04-22_020321_107442.zstd"
	worker_replicas:        200
