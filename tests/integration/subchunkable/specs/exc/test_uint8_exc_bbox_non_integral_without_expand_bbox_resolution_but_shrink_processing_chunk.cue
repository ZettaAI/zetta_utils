...
#DST_PATH: "assets/outputs/test_uint8_exc_bbox_non_integral_without_expand_bbox_resolution_but_shrink_processing_chunk"
#BBOX: {
	"@type": "BBox3D.from_coords"
	start_coord: [64 * 1024+10, 64 * 1024, 2000]
