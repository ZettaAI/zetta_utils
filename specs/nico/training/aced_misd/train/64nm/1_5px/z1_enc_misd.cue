...
#MODEL_CKPT: "gs://zetta-research-nico/training_artifacts/aced_misd_general/3.1.1_dsfactor2_thr1.5_lr0.0001_z1/last.ckpt"
...
#VAL_DATASETS: {
	"kronauer_cra9_defects": {"resolution": [32, 32, 42], "num_samples": 93},
						...
						"\(key)_z\(z_offset)": {
							...
							if key == "kronauer_cra9_defects" {
								sample_indexer: {
									...
									inner_indexer: {
										"@type": "LoopIndexer",
										desired_num_samples: 1000  // about one third of all samples
										inner_indexer: {
											"@type": "VolumetricNGLIndexer",
											resolution: [dataset.resolution[0] * #DS_FACTOR, dataset.resolution[1] * #DS_FACTOR, dataset.resolution[2]],
											chunk_size: [#CHUNK_XY, #CHUNK_XY, 1],
