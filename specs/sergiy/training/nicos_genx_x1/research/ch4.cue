...
#TRAINING_ROOT:  "gs://sergiy_exp/training_artifacts/nicos_gen_x"
#LR:             3e-4
#CLIP:           0e-5
#K:              3
#SIGNI_WEIGHT:   0.5
...
#LOWCONF_WEIGHT: 0.0
#ENC_CH:         4
#EXP_VERSION:    "128_256_chunk_z\(#IMG_CHUNK_Z)_sig\(#SIGNI_WEIGHT)_lr\(#LR)_fieldmag\(#FIELD_MAG)_xy\(#XY_WEIGHT)_conv3_cns_1chlowconf\(#LOWCONF_WEIGHT)_cross_encch\(#ENC_CH)_x4"
#CHUNK_XY:       1024
...
worker_image: "us.gcr.io/zetta-research/zetta_utils:sergiy_all_p39_x44"
worker_resources: {
	memory:           "18560Mi"
	"nvidia.com/gpu": "1"
}
