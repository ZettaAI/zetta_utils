...
if __name__ == "__main__":
    ...
    EXP_VERSION = f"1.0.3_M3_M7_C{CHANNELS}_lr{LR}_locality{LOCALITY_WEIGHT}_similarity{SIMILARITY_WEIGHT}_l1{L1_WEIGHT_START_VAL}-{L1_WEIGHT_END_VAL}_N1x4_repro_x2_4xt4_auto_2nodes"

    START_EXP_VERSION = (
        f"1.0.9_M3_M3_unet_fm32-256_lr0.0004_locality1.0_similarity0.0_l10.0-0.05_N4xB2"
    )
    ...
    lightning_train(
        ...
        # image="us.gcr.io/zetta-research/zetta_utils:nico_py3.9_20231106",
        image="us.gcr.io/zetta-research/zetta_utils:sergiy_all_p39_x213",
