...
#MATCH_OFFSETS_FLOW: {
	...
	let match_offsets_path = "\(#FOLDER)/match_offsets_z\(bbox._z_start)_\(bbox._z_end)"
	dst: {
...
#RELAX_FLOW: {
	...
	match_offsets: {
		"@type": "build_ts_layer"
		path:    "\(#FOLDER)/match_offsets_z\(bbox._z_start)_\(bbox._z_end)"
		//info_reference_path: #IMG_PATH
		on_info_exists: "overwrite"
	}
	pfields: {
...
#RUN_INFERENCE: {
	...
	worker_image: "us.gcr.io/zetta-research/zetta_utils:sergiy_all_p39_x153"
	worker_resources: {
		memory:           "18560Mi"
		"nvidia.com/gpu": "1"
	}
