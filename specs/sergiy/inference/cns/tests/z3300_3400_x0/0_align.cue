...
#BASE_ENC_PATH:        "TODO"
#ELASTIC_DEFECTS_PATH: "gs://sergiy_exp/aced/demo_x0/rigid_to_elastic/defect_mask"
...
#MATCH_OFFSETS_PATH: "\(#FOLDER)/match_offsets_manual_fixed_x1"
...
#RELAX_FLOW: {
	...
	dst_resolution: [32, 32, 45]
	bbox: #BBOX
	processing_chunk_sizes: [#RELAXATION_CHUNK]
...
#MATCH_OFFSETS_FLOW: {
	...
	processing_chunk_sizes: [[1024, 1024, #Z_END - #Z_START]]
	processing_crop_pads: [[128, 128, 0]]
	dst_resolution: [32, 32, 45]
	max_dist: 2
...
#RUN_INFERENCE: {
	...
	worker_image: "us.gcr.io/zetta-research/zetta_utils:sergiy_all_p39_x110"
	worker_resources: {
		memory:           "18560Mi"
		"nvidia.com/gpu": "1"
	}
