...
#MATCH_OFFSET_BASE: "\(#FOLDER)/match_offsets_stage1_v2"
...
#IMG_MASK_PATH:    "\(#FOLDER)/img_mask_stage1_v2\(#RELAXATION_SUFFIX)"
#AFF_MASK_PATH:    "\(#FOLDER)/aff_mask_stage1_v2\(#RELAXATION_SUFFIX)"
