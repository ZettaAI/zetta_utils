...
#CH:               3
#EXP_VERSION:      "tmp_512nm_1024nm_\(#SIGNI_WEIGHT)_x1_center\(#CENTERING_WEIGHT)_ch\(#CH)"

#MODEL_CKPT: null

"@type":      "mazepa.execute_on_gcp_with_sqs"
worker_image: "us.gcr.io/zetta-research/zetta_utils:sergiy_all_p39_x17"
worker_resources: {
	memory:           "18560Mi"
	"nvidia.com/gpu": "1"
}
