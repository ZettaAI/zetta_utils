...
#PAD_SIZE:		[16, 16, 16]
#MODEL_CKPT:  	null
#EXP_VERSION: 	"partial_blur_prob[1]_rate[1]_sigma[1.0-5.0](per_section)_t0"
...
#train_dset: #dset_settings & {
	...
	layer: read_procs: [
        ...
        {
            "@type": "PartialBlurrySection"
			prob: 1
            key: "data_in"
			rate: 1
			// rate: {"@type": "uniform_distr", low: 0.0, high: 0.5}
			// sigma: 5.0
			sigma: {"@type": "uniform_distr", low: 1.0, high: 5.0}
			per_section: true
            per_partial: false
        },
		{
