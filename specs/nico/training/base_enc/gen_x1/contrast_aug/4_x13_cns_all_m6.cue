...
#TILE_LOW:      0.0
#TILE_HIGH:     0.2
#EXP_VERSION:   "gamma_low\(#GAMMA_LOW)_high\(#GAMMA_HIGH)_prob\(#GAMMA_PROB)_tile_\(#TILE_LOW)_\(#TILE_HIGH)_lr\(#LR)_post\(#POST_WEIGHT)_cns_all_m6_3"

// #START_EXP_VERSION: "gamma_low0.75_high1.5_prob1.0_tile_0.0_0.2_lr0.0001_post1.8_cns_all"
#MODEL_CKPT:    "gs://zetta-research-nico/training_artifacts/base_encodings/gamma_low0.75_high1.5_prob1.0_tile_0.0_0.2_lr0.0001_post1.3_cns_all_m6_2/last.ckpt"

"@type":      "mazepa.execute_on_gcp_with_sqs"
worker_image: "us.gcr.io/zetta-research/zetta_utils:py3.9_torch_1.13.1_cu11.7_zu20230131_unet_m6"
worker_resources: {
	memory:           "18560Mi"
	"nvidia.com/gpu": "1"
}
...
#val_dset: #dset_settings & {
	...
	datasets: images: sample_indexer: {
		...
		bbox: {
			"@type":       "BBox3D.from_coords"
			start_coord: [1024, 0, 3180]
			end_coord: [3072, 3072, 3182]
			resolution: [256, 256, 45]
		}
	}
}
