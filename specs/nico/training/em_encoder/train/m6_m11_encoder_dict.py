...
if __name__ == "__main__":
    ...
    CHUNK_SIZE = 1024
    FM = 32
    INPUT_DS_FACTOR = 8  # M3 -> M6
    DS_FACTOR = 32
    CHANNELS = 4
    EXP_NAME = "general_coarsener_loss"
    TRAINING_ROOT = "gs://zetta-research-nico/training_artifacts"

    EXP_VERSION = f"1.0.1_M6_M11_C{CHANNELS}_lr{LR}_locality{LOCALITY_WEIGHT}_similarity{SIMILARITY_WEIGHT}_l1{L1_WEIGHT_START_VAL}-{L1_WEIGHT_END_VAL}_N1x4"
