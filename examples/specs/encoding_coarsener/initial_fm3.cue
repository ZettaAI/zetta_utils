...
regime: {
	...
	encoder: {
		...
		path:    "/mnt/disks/sergiy-x0/code/artificery/params/autoenc/encoder_fm3.json"
	}
	decoder: {
		"@type": "parse_artificery"
		path:    "/mnt/disks/sergiy-x0/code/artificery/params/autoenc/decoder_fm3.json"
	}
