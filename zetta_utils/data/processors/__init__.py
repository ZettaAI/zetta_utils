...
IntDivide = zu.spec_parser.register("IntDivide")(func_to_proc(basic_ops.int_divide))
...
Unsqueeze = zu.spec_parser.register("Unsqueeze")(func_to_proc(basic_ops.unsqueeze))
Squeeze = zu.spec_parser.register("Squeeze")(func_to_proc(basic_ops.squeeze))
Interpolate = zu.spec_parser.register("Interpolate")(func_to_proc(basic_ops.interpolate))
