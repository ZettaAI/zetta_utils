...
def clear_project_data(
    *,
    ...
    """
    Clear all data for a project including tasks, jobs, dependencies, and timesheets.
    ...
    with get_session_context(db_session) as session:
        ...
        try:
            ...
            # 3. Delete tasks (references jobs)
            ...
            job_result = session.execute(
                delete(JobModel).where(JobModel.project_name == project_name)
            )
            deleted_counts["jobs"] = job_result.rowcount
