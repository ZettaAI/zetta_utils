...
#TARGET_ENC_PATH:                   "gs://tmp_2w/nico/cra8/enc/z0_c1_thickthin_m6m6_enc"
#TARGET_MASKED_ENC_PATH:            "gs://tmp_2w/nico/cra8/enc/z0_masked_c1_thickthin_m6m6_enc"
...
#ALIGNED_FIELD_PATH:                "gs://tmp_2w/nico/cra8/field_fwd_align_c1_thickthin_m6m6_enc256" //_M6xSM\(_ALIGN_PARAMS["256"].sm)_M5xSM\(_ALIGN_PARAMS["128"].sm)_M4xSM\(_ALIGN_PARAMS["64"].sm)"
#ALIGNED_IMG_PATH:                  "gs://tmp_2w/nico/cra8/img_fwd_align_c1_thickthin_m6m6_enc256" //_M6xSM\(_ALIGN_PARAMS["256"].sm)_M5xSM\(_ALIGN_PARAMS["128"].sm)_M4xSM\(_ALIGN_PARAMS["64"].sm)"
#ALIGNED_ENC_PATH:                  "gs://tmp_2w/nico/cra8/enc_fwd_align_c1_thickthin_m6m6_enc256" //_M6xSM\(_ALIGN_PARAMS["256"].sm)_M5xSM\(_ALIGN_PARAMS["128"].sm)_M4xSM\(_ALIGN_PARAMS["64"].sm)"
...
target: {
	...
	stages: [
		...
		// 	"@type": "mazepa.concurrent_flow"
		// 	stages: [
		// 		for i in list.Range(3, 5, 1) for j in [2] {
...
#ENCODER_MODELS: [
	...
	{
		//path: "gs://zetta-research-nico/training_artifacts/general_coarsener_loss/4.0.0_M3_M6_3px_C4_lr0.0002_locality1.0_similarity0.0_l10.0-0.12_N1x4/last.ckpt.model.spec.json"
		//path: "gs://zetta-research-nico/training_artifacts/general_coarsener_loss/4.0.0_M3_M6_7px_C4_lr0.0002_locality1.0_similarity0.0_l10.0-0.12_N1x4/last.ckpt.model.spec.json"
		...
		//path: "gs://zetta-research-nico/training_artifacts/general_coarsener_loss/4.2.1_M3_M6_C1_lr0.0002_locality1.0_similarity0.0_l10.06-0.12_N1x4/last.ckpt.model.spec.json"
	...
	{
		//path: "gs://zetta-research-nico/training_artifacts/base_coarsener_cns/5_M3_M7_conv4_lr0.0001_equi0.5_post1.03_fmt0.8_cns_all/epoch=0-step=1584-backup.ckpt.static-1.13.1+cu117-model.jit"
